    ...
    def save_player_data(self):
            ...
            for pl in self.player.in_all_rounds():          # built-in oTree helper
                rows.append({
                    ...
                    "conversation_history": pl.field_maybe_none('conversation_history'),
            ...
            static_columns = [ "prolific_id","gender", "age", "occupation", "ai_use", "task_difficulty", "feedback",'random_payoff_part','experiment','conversation_history','comprehension_attempts','incorrect_answers','is_excluded']
